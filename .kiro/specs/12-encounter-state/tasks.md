...
- [ ] 2. Implement UI state data classes
- [ ] 2.1 Create CreatureState data class
  - Define fields: id, name, hpCurrent, hpMax, ac, position, conditions, isPlayerControlled, isDefeated
  - _Requirements: 7.3_

- [ ] 2.2 Create CompletionStatus enum
  - Define values: Victory, Defeat, Fled
  - _Requirements: 5.1, 5.2_

- [ ] 2.3 Create ActionChoice data class
  - Define fields: prompt, options
  - _Requirements: 3.5_

- [ ] 2.4 Create EncounterUiState data class
...
- [ ] 3. Implement intent sealed interface
- [ ] 3.1 Create EncounterIntent sealed interface
  - Define StartEncounter intent with creatures, surprisedCreatures, mapGrid parameters
  - Define EndTurn intent
  - _Requirements: 1.1, 2.2, 4.1_

- [ ] 3.2 Add combat action intents
